...
class UserController extends Controller
{
    ...
    public function remove_project(Request $request){
        ...
        $request->session()->put('program_details', $program_details);
        return response()->json(['program_details' => $program_details ]);
    }
    ...
    public function save_project(Request $request){
       ...
       $project_check = ProjectDetails::where('project', $request->input("project_name"))
                            ->where('programmer_id', Auth::user()->id)
                            ->first();
        ...
        if($project_check){
            $message = json_encode(array(
                            "type" => "danger",
                            "title" => "Info..!",
                            "message" => 'You Have Created This Project Before, Kindly delete or edit it..!'
            ));
            Session::flash('flash_message', $message);
            return redirect()->back();
        }
