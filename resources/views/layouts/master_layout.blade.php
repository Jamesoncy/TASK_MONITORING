...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="{{ url('project/ongoing-projects') }}" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>I</b>T</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>IT -</b>DEPT</span>
    </a>
...
">DEVELOPERS TIME TABLE FOR CENTRALIZATION</span>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="{{ url('project/ongoing-projects') }}"><i class="fa fa-book"></i> <span>Ongoing Projects</span></a></li>
       <li class="treeview">
          @if(Auth::user()->role == 1)
          <a href="#">
        ...
        <li class="treeview">
            ...
            <a href="#">
              <i class="fa fa-dashboard"></i> <span>Project Timeline</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
          ...
          <ul class="treeview-menu">
            <li><a href="{{ url('projects') }}"><i class="fa fa-circle-o"></i>Project List</a></li>
            @if(Auth::user()->role == 0)
            <li><a href="{{ url('programmer/create-project') }}"><i class="fa fa-circle-o"></i>Create Project</a></li>
            @endif
          </ul>
        </li>
        @if(Auth::user()->role == 1)
        <li><a href="{{ url('project/approve-projects') }}"><i class="fa fa-thumbs-up"></i> <span>Approve Projects</span></a></li>
        @endif
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
       ...
       @if(Session::has('flash_message'))
        @php
        $i = json_decode(Session::get('flash_message'));
        $type  = $i->type; 
        $title  = $i->title; 
        $message  = $i->message; 
        $icon = "";
          if($type == "warning") $icon = "fa-warning";
          else if($type == "success") $icon = "fa-check";
          else if($type == "danger") $icon = "fa-ban";
          
        @endphp
        <div class="box-body">
              <div class="alert alert-@php echo $type @endphp alert-dismissible">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                <h4><i class="icon fa fa-ban"></i> @php echo $title @endphp</h4>
...
@endif
    ...
    <div class="alert alert-danger" id = "layout-error" style = "display:none">
...
<script src="{{  URL::asset('public/excel/src/jquery.table2excel.js') }}"></script>
...
$(document).ready(function(){
    ...
    function alert_message(title, data){
        layout_error.show();
        $.each(data, function(i, item) {
            layout_error.append("<li>" + item + "</li>");
        });
    }
});
</script>
